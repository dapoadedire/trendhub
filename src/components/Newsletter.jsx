      ...
      >
        <div className="">
          ...
          <p className="mt-4 text-xl text-gray-600">
            Stay up-to-date with the latest deals, discounts, and promotions
            from our store. Sign up for our newsletter and receive exclusive
            offers, new product announcements, and helpful tips straight to your
            inbox.
          </p>
        </div>
        <form
